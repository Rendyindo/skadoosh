...
doshallow(){
    ...
    expect -c 'repo init -u https://github.com/ResurrectionRemix/platform_manifest -b lollipop5.1 --depth 1 -q --reference $DIR/$ROMNAME/full/; expect "Enable color display in this user account (y/N)?"; send -- "y\r"; expect eof'
...
dofull(){
    ...
    expect -c 'repo init -u https://github.com/ResurrectionRemix/platform_manifest -b lollipop5.1; expect "Enable color display in this user account (y/N)?"; send -- "y\r"; expect eof'
